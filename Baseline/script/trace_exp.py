...
if __name__ == "__main__":
    ...
    for trace in trace_list:
        if (using_ramdisk == 0):
            ...
            cmd = exector + " -t " + operation_type + " -i " + trace_full_path + " -m " + method_type 
            ...
            if (operation_type == "u"):
                ...
                cmd = exector + " -t " + operation_type + " -i " + trace_ramdisk_path + " -m " + method_type 
