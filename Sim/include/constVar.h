...
enum PROTCOL_CODE_SET {CLIENT_UPLOAD_CHUNK = 0, CLIENT_UPLOAD_RECIPE, 
    CLIENT_UPLOAD_RECIPE_END, CLIENT_LOGIN_UPLOAD, CLIENT_LOGIN_DOWNLOAD, 
    CLIENT_RESTORE_READY, SERVER_RESTORE_CHUNK, SERVER_RESTORE_RECIPE, 
    SERVER_RESTORE_FINAL, CLIENT_KEY_GEN, KEY_MANAGER_KEY_GEN_REPLY, 
    SERVER_LOGIN_RESPONSE, SERVER_FILE_NON_EXIST};
...
enum DAE_TYPE {PLAIN_DAE = 0, CE_DAE, TED_DAE, DUPLESS_DAE};
